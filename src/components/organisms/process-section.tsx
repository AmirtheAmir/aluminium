...
import { ProcessTimeline } from "@/components/molecules/process-timeline";
import { ProcessPreview } from "@/components/molecules/process-preview";
    ...
    >
      <div className="sticky top-0 flex min-h-screen w-full flex-col gap-12 bg-background-primary py-26">
        ...
        <div className="flex w-full flex-col gap-3 lg:flex-row">
          ...
          />
          <ProcessTimeline activeIndex={activeIndex} steps={processSteps} />
        </div>
      </div>
    </section>
  );
