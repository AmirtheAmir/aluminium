import {
  FaqQuestionList,
  type FaqQuestion,
} from "@/components/molecules/faq-question-list";
...
const faqQuestions: FaqQuestion[] = [
  ...
  {
    question: "Can we customize workflows and processes?",
    answer:
  ...
  {
    question: "Can Aluminium help with approvals and ownership?",
    answer:
...
export function FrequentlyAskedQuestions({
  ...
  return (
    ...
    >
      ...
      />
      <FaqQuestionList questions={faqQuestions} />
    </section>
  );
}
